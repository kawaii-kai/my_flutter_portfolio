...
import 'package:my_portfolio/features/slide_skills_card/front_back_database/front_back_database_model.dart';
import 'package:my_portfolio/features/slide_skills_card/hover_style.dart';

class FrontBackDatabaseCard extends StatelessWidget {
  final double maxWidth;
  final bool isMobile;
  const FrontBackDatabaseCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    late FrontBackDatabaseModel skillsModel = FrontBackDatabaseModel();
